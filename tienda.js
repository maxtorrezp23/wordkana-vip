...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    // Función para generar un multiplicador aleatorio según el nivel VIP
    function getRandomPriceMultiplier(level, productName) {
        ...
        // Rangos de variación según el nivel VIP (incremento de 500% = 6x desde VIP 2)
        const ranges = {
        ...
        // Generar número pseudo-aleatorio consistente basado en el seed
